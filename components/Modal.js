...
function Modal() {
    ...
    const uploadPost = async () => {
        ...
        //2) get the post Od for th newly created post
                        ...
                        <div>
                            ...
                            <div>
                                <div className='mt-3 text-center sm:mt-5'>
                                    ...
                                    <div>
                                        <input
                                            className='border-none focus:ring-0 w-full text-center' type="text"
                                            ref={captionRef} placeholder="Please enter the caption..." />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className='mt-5 sm:mt-6'>
                                ...
                                <button
                                    ...
                                    className="inline-flex justify-center w-full rounded-md border border-transparent shadow-sm px-4 py-2 bg-emerald-600 text-base font-medium text-white hover:bg-emerald-700 focus:outline-none focus:r focus:ring-offset-2 focus:ring-emerald-400 sm:text-sm disabled:bg-gray-300 disabled:cursor-not-allowed hover:disabled:bg-gray-300"
                                    onClick={()=>uploadPost()}
                                >
